...
const FILES = [
  ...
  { id: 6, file_id: 6, name: '体检报告-2026年度.pdf', ext: '.pdf', size: 5214208, mtime: now - day * 5, source_name: 'QQ 文件', volatile: true, state: 'missing', preserved_path: '/Users/demo/Library/Application Support/Inktable/preserved/体检报告-2026年度.pdf', path: '/Users/demo/Documents/Tencent Files/file/体检报告-2026年度.pdf' },
...
const ANSWER = {
  ...
  hedge: null,
  citations: [
    { tag: 'C1', file_name: '装修报价单-整包-0806.pdf', file_path: FILES[1].path, page: 4, section_path: '三、门窗工程 › 3.1 封阳台', snippet: '封阳台采用断桥铝 70 系窗框、5+27A+5 双层中空玻璃，单价 680 元/㎡。', text: '封阳台采用断桥铝 70 系窗框、5+27A+5 双层中空玻璃，单价 680 元/㎡。北向阳台 6.4㎡，含窗纱一体与排水孔加工，合计 4352 元。' },
    { tag: 'C2', file_name: '装修合同-金螳螂-0801.pdf', file_path: '/Users/demo/xwechat_files/msg/file/2026-08/装修合同-金螳螂-0801.pdf', page: 3, section_path: '第二章 › 工程范围', snippet: '乙方负责封阳台、全屋地面找平及厨卫防水工程。', text: '乙方负责封阳台、全屋地面找平及厨卫防水工程，防水层高度不低于 1.8 米，并提供闭水试验记录。' },
    { tag: 'C3', file_name: '装修报价单-整包-0806.pdf', file_path: FILES[1].path, page: 6, section_path: '四、付款方式', snippet: '竣工验收合格后 7 日内支付尾款 10%。', text: '合同签订后支付 30% 作为首期款；水电验收合格支付 30%；泥木完工支付 30%；竣工验收合格后 7 日内支付尾款 10%。' },
  ],
};

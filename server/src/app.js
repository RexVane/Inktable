...
function createOpenApi(config) {
  ...
  const groups = {
    ...
    'Widget': ['/api/v1/assistants/{id}/clients','/api/v1/widget-clients/{id}/rotate','/api/v1/public/widget/token','/api/v1/public/widget/sessions','/api/v1/public/widget/sessions/{id}/messages','/api/v1/public/widget/sessions/{id}/handoff','/api/v1/public/widget/sessions/{id}','/api/v1/handoffs','/api/v1/handoffs/{id}'],

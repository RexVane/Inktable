...
function createOpenApi(config) {
  ...
  const groups = {
    ...
    'Conversations': ['/api/v1/conversations','/api/v1/conversations/{id}','/api/v1/conversations/{id}/messages','/api/v1/messages/{id}/feedback','/api/v1/traces','/api/v1/traces/{id}','/api/v1/traces/{id}/stages/route','/api/v1/traces/{id}/stages/recall','/api/v1/traces/{id}/stages/recall/filter','/api/v1/traces/{id}/stages/recall/retry-channel','/api/v1/traces/{id}/stages/recall/chunks/{chunkId}','/api/v1/traces/{id}/stages/recall/export','/api/v1/traces/{id}/stages/fusion','/api/v1/traces/{id}/stages/fusion/weights','/api/v1/traces/{id}/stages/fusion/reset-weights','/api/v1/traces/{id}/stages/fusion/calculation/{candidateId}','/api/v1/traces/{id}/stages/fusion/candidates','/api/v1/traces/{id}/stages/fusion/chunks/{candidateId}','/api/v1/traces/{id}/stages/fusion/logs','/api/v1/traces/{id}/stages/fusion/export','/api/v1/traces/{id}/stages/fusion/rerun','/api/v1/traces/{id}/stages/rerank','/api/v1/traces/{id}/stages/rerank/chunks/{chunkId}','/api/v1/traces/{id}/stages/rerank/config','/api/v1/traces/{id}/stages/rerank/compare','/api/v1/traces/{id}/stages/rerank/logs','/api/v1/traces/{id}/pipeline','/api/v1/traces/{id}/replay','/api/v1/traces/{id}/compare/{otherId}','/api/v1/citations/{id}'],
  ...
  const methods = {
    ...
    '/api/v1/conversations':['get','post'], '/api/v1/conversations/{id}':['get','delete'], '/api/v1/conversations/{id}/messages':['post'], '/api/v1/messages/{id}/feedback':['post'], '/api/v1/traces':['get'], '/api/v1/traces/{id}':['get'], '/api/v1/traces/{id}/stages/route':['get'], '/api/v1/traces/{id}/stages/recall':['get'], '/api/v1/traces/{id}/stages/recall/filter':['post'], '/api/v1/traces/{id}/stages/recall/retry-channel':['post'], '/api/v1/traces/{id}/stages/recall/chunks/{chunkId}':['get'], '/api/v1/traces/{id}/stages/recall/export':['get'], '/api/v1/traces/{id}/stages/fusion':['get'], '/api/v1/traces/{id}/stages/fusion/weights':['put'], '/api/v1/traces/{id}/stages/fusion/reset-weights':['post'], '/api/v1/traces/{id}/stages/fusion/calculation/{candidateId}':['get'], '/api/v1/traces/{id}/stages/fusion/candidates':['get'], '/api/v1/traces/{id}/stages/fusion/chunks/{candidateId}':['get'], '/api/v1/traces/{id}/stages/fusion/logs':['get'], '/api/v1/traces/{id}/stages/fusion/export':['get'], '/api/v1/traces/{id}/stages/fusion/rerun':['post'], '/api/v1/traces/{id}/stages/rerank':['get'], '/api/v1/traces/{id}/stages/rerank/chunks/{chunkId}':['get'], '/api/v1/traces/{id}/stages/rerank/config':['put'], '/api/v1/traces/{id}/stages/rerank/compare':['post'], '/api/v1/traces/{id}/stages/rerank/logs':['get'], '/api/v1/traces/{id}/pipeline':['get'], '/api/v1/traces/{id}/replay':['post'], '/api/v1/traces/{id}/compare/{otherId}':['get'], '/api/v1/citations/{id}':['get'],
...
async function createApp(overrides = {}) {
  ...
  app.get('/api/v1/traces/:id/stages/route', async request => data(query.getTraceRouteStage(request.params.id, workspace(request))));
  app.get('/api/v1/traces/:id/stages/recall', async request => data(query.getTraceRecallStage(request.params.id, workspace(request), request.query)));
  app.post('/api/v1/traces/:id/stages/recall/filter', async request => data(query.getTraceRecallStage(request.params.id, workspace(request), request.body || {})));
  app.post('/api/v1/traces/:id/stages/recall/retry-channel', async request => data(query.retryRecallChannel(request.params.id, request.body?.channelId, workspace(request))));
  app.get('/api/v1/traces/:id/stages/recall/chunks/:chunkId', async request => data(query.getRecallChunk(request.params.id, request.params.chunkId, workspace(request))));
  app.get('/api/v1/traces/:id/stages/recall/export', async request => data(query.exportRecallCandidates(request.params.id, workspace(request), request.query?.format)));
  app.get('/api/v1/traces/:id/stages/fusion', async request => data(query.getTraceFusionStage(request.params.id, workspace(request), request.query)));
  app.put('/api/v1/traces/:id/stages/fusion/weights', async request => data(query.updateFusionWeights(request.params.id, request.body || {}, workspace(request))));
  app.post('/api/v1/traces/:id/stages/fusion/reset-weights', async request => data(query.resetFusionWeights(request.params.id, workspace(request))));
  app.get('/api/v1/traces/:id/stages/fusion/calculation/:candidateId', async request => data(query.getFusionCalculation(request.params.id, request.params.candidateId, workspace(request))));
  app.get('/api/v1/traces/:id/stages/fusion/candidates', async request => paginated(query.getFusionCandidates(request.params.id, workspace(request), request.query)));
  app.get('/api/v1/traces/:id/stages/fusion/chunks/:candidateId', async request => data(query.getFusionChunk(request.params.id, request.params.candidateId, workspace(request))));
  app.get('/api/v1/traces/:id/stages/fusion/logs', async request => data(query.getFusionLogs(request.params.id, workspace(request))));
  app.get('/api/v1/traces/:id/stages/fusion/export', async request => data(query.exportFusionCandidates(request.params.id, workspace(request), request.query?.format)));
  app.post('/api/v1/traces/:id/stages/fusion/rerun', async request => data(await query.rerunFusionStage(request.params.id, request.body || {}, workspace(request), request.id)));
  app.get('/api/v1/traces/:id/stages/rerank', async request => data(query.getTraceRerankStage(request.params.id, workspace(request), request.query)));
  app.get('/api/v1/traces/:id/stages/rerank/chunks/:chunkId', async request => data(query.getRerankChunk(request.params.id, request.params.chunkId, workspace(request))));
  app.put('/api/v1/traces/:id/stages/rerank/config', async request => data(query.updateRerankConfig(request.params.id, request.body || {}, workspace(request))));
  app.post('/api/v1/traces/:id/stages/rerank/compare', async request => data(query.compareRerank(request.params.id, workspace(request))));
  app.get('/api/v1/traces/:id/stages/rerank/logs', async request => data(query.getRerankLogs(request.params.id, workspace(request))));
  app.get('/api/v1/traces/:id/pipeline', async request => data(query.getTracePipeline(request.params.id, workspace(request), request.query)));
  app.post('/api/v1/traces/:id/replay', async request => {
    const key = request.headers['idempotency-key'] ? String(request.headers['idempotency-key']) : null;
    return data(await query.replayTrace(request.params.id, request.body || {}, workspace(request), request.id, key));
  });
  app.get('/api/v1/traces/:id/compare/:otherId', async request => data(query.compareTraces(request.params.id, request.params.otherId, workspace(request))));

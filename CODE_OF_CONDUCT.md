<p align="right">
  <strong>English</strong> | <a href="./CODE_OF_CONDUCT.zh-CN.md">简体中文</a>
</p>
...
Report unacceptable behavior to the repository owner via a
[private GitHub security advisory](https://github.com/RexVane/Ordo/security/advisories/new)
(use that channel for conduct reports too if you need privacy) or through the
